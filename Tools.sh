...
echo -e
echo " ➜ press 1 : To install all packages  for Termux ❨ 0.9 GB Storage  ❩"
echo -e
echo " ➜ press 2 : To install all packages  for Linux ❨ 0.9 GB Storage  ❩"
echo 
echo " ➜ press 3 : To install tools for Termux & Linux "

echo 
echo " ➜ Press 4 : To Update Script"
