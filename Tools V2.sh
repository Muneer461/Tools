...
echo    " ➜ press 3 : to install all packages  for linux sudo users ❨ 0.9 gb to download  ❩"
echo   " ➜ press 4 : to install tools for Termux (25 mb to download)"
echo   " ➜ press 5 : to install tools for  Linux (25 mb to download) "
#echo -e
echo   " ➜ press 6 : to install black termux & lemon tool (for termux users) (600mb download )"
#echo -e
echo   " ➜ press 7 : to install metasploit for  linux ( 800mb to download )"
echo   " ➜ prees 8 : to install metasploit for  termux ( 800mb to download )"
echo 
echo   " ➜ press 9 : to update script"
...
clear
echo   " ➣ please wait packages installing......."
echo 
echo 
echo    " ➣ it will take some time.........."
echo 
...
sudo apt install ncurses-utils
...
sudo apt install root-repo
sudo apt install unstable-repo
sudo apt x11-repo
sudo apt aircrack-ng
sudo apt install while
sudo apt install beef-xss
sudo apt install ruby clang
sudo pip install mechanize requests bs4
clear 
exit
